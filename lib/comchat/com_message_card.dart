import 'package:eco_resolve/comchat/com_message.dart';
  ...
  Widget build(BuildContext context) {
      ...
      children:[
        ...
        Container(
            ...
            child: CircleAvatar(
              ...
              child: Image.asset('assets/images/roboticon.png', width:isDesktop? 25:10),
            ),
          ),
        Container(
          constraints: BoxConstraints(maxWidth:screenSizeWidth *.6), //accd length of text it will manage boxs width
          margin: EdgeInsets.only(bottom: screenSizeHeight * .02, left:screenSizeWidth *.02),
          
            padding: EdgeInsets.symmetric(vertical:screenSizeHeight * .01, horizontal: screenSizeWidth * .03),
              ...
              child:Text(commessage.commsg,
                style:TextStyle(color: Colors.white, fontSize: isDesktop? 14:8, fontWeight: FontWeight.w400),),
    ...
    Row(
      ...
      children:[
        Container(
          constraints: BoxConstraints(maxWidth: screenSizeWidth *.6), //accd length of text it will manage boxs width
          margin: EdgeInsets.only(bottom: screenSizeHeight * .02, right: screenSizeWidth *.02),
            padding: EdgeInsets.symmetric(vertical: screenSizeHeight * .01, horizontal: screenSizeWidth * .03),
              decoration:BoxDecoration(
                border:Border.all(color:CustomColor.greenSecondary),
        ...
        child:CircleAvatar(
          radius:isDesktop? 20:10,
          backgroundColor:CustomColor.bgLight1,
          child:const Icon(Icons.person, color:CustomColor.greenSecondary)
        ),),
