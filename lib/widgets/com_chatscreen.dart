import 'package:eco_resolve/comchat/com_message_card.dart';
import 'package:eco_resolve/comchat/comchat_controller.dart';
import 'package:eco_resolve/constants/colors.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ComChatScreen extends StatefulWidget {
  const ComChatScreen({super.key});

  @override
  State<ComChatScreen> createState() => _ComChatScreenState();
}

class _ComChatScreenState extends State<ComChatScreen> {
            ...
            child: Scaffold(
              ...
              body: Obx(
                () => ListView(
                  ...
                  children: _c.list.map((e) =>ComMessageCard(commessage: e)).toList(),
                ),
              ),
            ),
          ),
